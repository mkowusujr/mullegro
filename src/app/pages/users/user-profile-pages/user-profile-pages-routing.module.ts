...
const routes: Routes = [
  {path: 'user/settings', component: UserProfileEditPageComponent, canActivate: [AuthGuard]},
  {path: 'user/:username', component: UserProfilePageComponent}
];

@NgModule({
  imports: [RouterModule.forChild(routes), UserProfilePageModule, UserProfileEditPageModule],
